...
- Появляется сообщение: "Успешно. Операция одобрена Банком"
    ...
    Тест №2 TestSuccessfulPurchaseByCreditByApprovedCard
- Открываем страницу http://localhost:8080
...
- Появляется сообщение: "Успешно. Операция одобрена Банком"
    ...
    Тест №3 TestUnsuccessfulPurchaseByDeclinedCard
- Открываем страницу http://localhost:8080
...
- Появляется сообщение: "Ошибка. Ошибка! Банк отказал в проведении операции"
    ...
    Тест №5 TestPurchaseCardNumberEmptyField
- Открываем страницу http://localhost:8080
- Нажимаем на кнопку "Купить"
...
- Появляется сообщение под полем "Номер карты": "Неверный формат"
    ...
    Тест №6 TestPurchaseByCreditCardNumberEmptyField
- Открываем страницу http://localhost:8080
- Поле "Номер карты" оставляем пустым
- Нажимаем на кнопку "Купит в кредит"
- Вводим в поле "Владелец" значение "Yulia Maximova" (или другие имя и фамилию на латинице в слова через пробел; возможно с "'" и "-")
- Вводим в поле "Месяц" значение "11" или другое в диапазоне от 01 до 12
- Вводим в поле "Год" значение "24" или другое в диапазоне от 24 до 28 
- Вводим в поле "CVC/CVV" значение "675" (или другое в диапазоне от 001 до 999)
...
- Появляется сообщение под полем "Номер карты": "Неверный формат"
  ...
  Тест №7 TestPurchaseCardNumberShortLength
- Открываем страницу http://localhost:8080
- Нажимаем на конопку "Купить"
...
- Появляется сообщение под полем "Номер карты": "Неверный формат"
  ...
  Тест №8 TestPurchaseByCreditCardNumberShortLength
- Открываем страницу http://localhost:8080
- Вводим номер карты: 4444 (или другое значение длиной от 1 до 15 цифр)
- Нажимаем на конопку "Купить в кредит"
- Вводим в поле "Владелец" значение- "Yulia Maximova" (или другие имя и фамилию на латинице в слова через пробел; возможно с "'" и "-")
...
- Появляется сообщение: "Ошибка. Ошибка! Банк отказал в проведении операции"
  ...
  Тест №1 TestPurchaseCardHolderNameInCyrillic
- Открываем страницу http://localhost:8080
- Нажимаем на конопку "Купить"
- Вводим номер карты: 4444 4444 4444 4441
...
- Появляется сообщение под полем "Владелец": "Ошибка! Введите данные на латинице"
  ...
  Тест№2 TestPurchaseByCreditCardHolderNameInCyrillic
- Открываем страницу http://localhost:8080
- Нажимаем на конопку "Купить в кредит"
- Вводим номер карты: 4444 4444 4444 4441
- Вводим в поле "Владелец" значение- "Юлия Максимова"  (или другие имя и фамилию на кириллице)
...
- Появляется сообщение под полем "Владелец": "Ошибка! Введите данные на латинице"
  ...
  Тест№3 TestPurchaseCardHolderInOneWord
- Открываем страницу http://localhost:8080
- Нажимаем на конопку "Купить"
- Вводим номер карты: 4444 4444 4444 4441
...
- Появляется сообщение под полем "Владелец": "Ошибка! Введите данные в два слова"
  ...
  Тест №4 TestPurchaseByCreditCardHolderInOneWord
- Открываем страницу http://localhost:8080
- Нажимаем на конопку "Купить в кредит"
- Вводим номер карты: 4444 4444 4444 4441
- Вводим в поле "Владелец" значение"- "yuliamaximova" (или другие имя и фамилию на латиницев 1 слово)
...
- Появляется сообщение под полем "Владелец": "Ошибка! Введите данные в два слова"
  ...
  Тест №5 TestPurchaseCardHolderNameWith
- Открываем страницу http://localhost:8080
- Нажимаем на конопку "Купить"
- Вводим номер карты: 4444 4444 4444 4441
...
- Появляется сообщение под полем "Владелец": "Ошибка! Введите корректные данные"
  ...
  Тест №6 TestPurchaseByCreditInvalidCardHolder6
- Открываем страницу http://localhost:8080
- Нажимаем на конопку "Купить в кредит"
- Вводим номер карты: 4444 4444 4444 4441
- Вводим в поле "Владелец" значение"- "yulia@maximova" (или другие имя и фамилию на латиницев 1 слово c любым спецсимвволом, кроме апострофа и дефиса)
